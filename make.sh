...
sudo LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$SPDK_LIB_DIR:$DPDK_LIB_DIR:$VFIO_LIB_DIR:"$test_root/passthru":"$test_root/rout" $test_root/hello_world/hello_bdev --json $test_root/pass.json -m [0-3]
